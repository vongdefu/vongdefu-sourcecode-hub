...
public class TokenInterceptor extends HandlerInterceptorAdapter {
     ...
     *                如 @PostMapping("/api_token") 标注的方法是： TokenController#apiToken(java.lang.String, java.lang.String, java.lang.String)
     *                再如： @PostMapping("user_token") 标注的方法是： TokenController#userToken(java.lang.String, java.lang.String)
     * @return
     * @throws Exception
     */
    @Override
